...
export default function AddStudent() {
  ...
  const { currentClass , addStudent , setView } = useContext(Context)

  const [ name , setName ] = useState('')

  const [ subjects , setSubjects ] = useState([...currentClass.subjects.map(c => ({ offering: true, name: c , firstTest: 0 , secondTest: 0, exam: 0 }))])
